...
// Single-phase partial waveform TP0 frame count (the byte after the level byte
// in each active LUT). Good Display's reference default 0x30 (48 frames) ghosts
// on WFT0290CZ10 (LP) lots: 48 frames don't switch the particles fully, leaving
// a residual of the previous frame. Lengthened to 0x60 (96) so changed pixels
// migrate more completely -> fainter ghost. Larger = less ghost but slower per
// partial and risks DC imbalance greying the background; tune per lot/temp.
static constexpr uint8_t PARTIAL_PHASE = 0x60;

const uint8_t GDEW029T5D::LUT_VCOM1[] = {0x02, PARTIAL_PHASE, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
                                         0x00, 0x00,          0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                         0x00, 0x00,          0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                         0x00, 0x00,          0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const uint8_t GDEW029T5D::LUT_WW1[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const uint8_t GDEW029T5D::LUT_BW1[] = {0x80, PARTIAL_PHASE, 0x00, 0x00, 0x00, 0x01,  // LOW - GND (Black->White)
                                       0x00, 0x00,          0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                       0x00, 0x00,          0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                       0x00, 0x00,          0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const uint8_t GDEW029T5D::LUT_WB1[] = {0x40, PARTIAL_PHASE, 0x00, 0x00, 0x00, 0x01,  // HIGH - GND (White->Black)
                                       0x00, 0x00,          0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                       0x00, 0x00,          0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                       0x00, 0x00,          0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const uint8_t GDEW029T5D::LUT_BB1[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
void GDEW029T5D::set_full_update_every(uint32_t full_update_every) { this->full_update_every_ = full_update_every; }
