...
const unsigned char GDEW042M01::LUT_VCOM1_PARTIAL[] = {
    0x00, T1,   T2,   T3,   T4,   1,    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

const unsigned char GDEW042M01::LUT_WW1_PARTIAL[] = {  // 10 w
    0x02, T1,   T2,   T3,   T5,   1,    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

const unsigned char GDEW042M01::LUT_BW1_PARTIAL[] = {  // 10 w
    0x5A, T1,   T2,   T3,   T4,   1,    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

const unsigned char GDEW042M01::LUT_WB1_PARTIAL[] = {  // 01 b
    0x84, T1,   T2,   T3,   T4,   1,    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

const unsigned char GDEW042M01::LUT_BB1_PARTIAL[] = {  // 01 b
    0x01, T1,   T2,   T3,   T6,   1,    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
void GDEW042M01::set_full_update_every(uint32_t full_update_every) { this->full_update_every_ = full_update_every; }
...
void GDEW042M01::display() {
  ...
  if (full_update) {
    ...
    this->command(0x10);  // Transfer old data
    this->start_data_();
    this->write_array(this->oldData,
                      this->get_buffer_length_());  // Transfer the actual displayed data
    this->end_data_();

    this->command(0x13);  // Transfer new data
    this->start_data_();
    this->write_array(this->buffer_,
                      this->get_buffer_length_());  // Transfer the actual displayed data
    this->end_data_();
    for (uint32_t i = 0; i < this->get_buffer_length_(); i++)
      this->oldData[i] = this->buffer_[i];
